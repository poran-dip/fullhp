      ...
      <main className="flex-1 container mx-auto px-4 py-12 max-w-6xl">
        ...
        <section className="mb-16 px-4">
          ...
          <div className="max-w-2xl mx-auto space-y-6 text-center text-muted-foreground">
            <p>
              Eazydoc didn&apos;t start with a grand plan—it started with
              Dikshayn convincing{" "}
              <span className="italic">(read: nagging)</span> me to join yet
              another hackathon. Once we were in, we teamed up with Rajdeep and
              Hirok to build something real: a seamless healthcare platform that
              connects patients, doctors, and hospitals with ease, making
              medical access simpler than ever.
            </p>
            <p>
              With Dikshayn leading the AI-driven medbot and me handling most of
              the backend, we pushed ourselves beyond what we&apos;d ever built
              before. Every late night, every refactor, and every unexpected bug
              brought us here—turning what started as a hackathon project into
              something we&apos;re truly proud of.
            </p>
            <p>
              Eazydoc isn&apos;t just an idea anymore. It&apos;s a step toward
              accessible, AI-powered healthcare.
            </p>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-center mb-8">
            Our Team: Cosmic Titans
          </h2>
          <div className="grid md:grid-cols-2 gap-6">
            {teamMembers.map((member) => (
              <Card
                key={member.name}
                className="flex items-center p-6 group hover:bg-gray-50 transition-colors duration-300"
              >
        ...
        <section>
          ...
          <div className="text-center">
            ...
            <p className="text-muted-foreground">
              <span className="font-semibold">Address:</span> Guwahati, Assam,
              IN - 781034
            </p>
