    ...
    try {
      ...
      const appointmentDateTime = formData.appointmentDate
        ? new Date(
            ...
            parseInt(formData.appointmentTime.split(":")[0], 10),
            parseInt(formData.appointmentTime.split(":")[1], 10),
          )
        : null;
      ...
      <Dialog open={showTermsDialog} onOpenChange={setShowTermsDialog}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              By creating an account and booking an appointment, you agree to
          ...
          <div className="space-y-4 text-sm max-h-75 overflow-y-auto py-2">
            ...
            <ol className="list-decimal pl-5 space-y-2">
              <li>
                Your submitted information will be used exclusively to process
                and display your appointment-related preferences.
              </li>
              <li>
                Due to the developmental nature of EazyDoc, submitted data may
                be accessible to the Cosmic Titans development team and other
                users.
              </li>
              <li>
                EazyDoc is not designed for secure or confidential handling of
                personal or sensitive medical information.
              </li>
              <li>
                You understand that you submit information at your own risk.
              </li>
            </ol>
            <p className="pt-2">
