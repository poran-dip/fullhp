    ...
    <div className="min-h-screen bg-linear-to-b from-slate-50 to-slate-100">
      <div className="max-w-3xl mx-auto px-4 py-12 sm:py-16">
        ...
        <div className="prose prose-slate max-w-none">
          <p>
            Welcome to EazyDoc, an application developed and maintained by the
            team known as Cosmic Titans ("we," "us," or "our"). By accessing or
            using the EazyDoc platform ("the Platform"), you ("you" or "User")
          ...
          <section>
            ...
            <p>
              We do not warrant that the Platform will operate uninterrupted,
              error-free, or free of viruses or other harmful components. Under
              no circumstances shall EazyDoc, its developers, or affiliates be
              liable for any direct, indirect, incidental, special,
              consequential, or exemplary damages arising from your use or
          ...
          <section>
            ...
            <p>
              ...
              to provide accurate, lawful, and medically relevant information
              when using the Platform.
            </p>
            <p>You further acknowledge and agree that:</p>
            <ul className="list-disc pl-6 space-y-1">
              <li>
                Any medical information you submit is provided voluntarily and
          ...
          <section>
            ...
            <p>
              We do not collect any personal information beyond the data you
              voluntarily submit through the Platform. Your submitted content is
              stored solely for the purpose of facilitating your intended use of
              the Platform.
            </p>
            <p>
          ...
          <section>
            ...
            <p>
              ...
              of the Platform shall be resolved exclusively in the competent
              courts located within Guwahati, Assam, India.
            </p>
          </section>
          ...
          <p className="font-semibold">
            By accessing or using EazyDoc, you acknowledge that you have read,
